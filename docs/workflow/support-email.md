...
How we handle the shared support inbox.

The support inbox is everyone's responsibility. A message that sits unanswered reflects badly on the whole team, and splitting coverage across the team means no one person gets buried. This page covers how we keep the inbox flowing without dropping anything or duplicating work.

## The core rules

**Check the inbox regularly.** At least a couple of times a day during working hours. More often if you're on point that day or if volume is high.

**If you're going to reply, take ownership.** Mark the message as read and respond. That signals to everyone else that it's handled.

**If you can't or won't reply, leave it visible to the team.** This is the important part. Options:
...
- **Acknowledge the problem in your own words.** Shows you actually read it.
- **Give a concrete next step.** Either an answer, or a timeline, or a question to unblock you.
- **Don't promise what you can't deliver.** If you're not sure when something will be fixed, say so — "We're looking into it, I'll follow up by end of day" is better than a vague "soon."
...
If volume gets high enough, we may move to a lightweight rotation where one person is "on support" for the day or the week. For now, the shared-responsibility model works fine as long as everyone participates.

!!! tip "If you notice one person handling everything"
    That's a burnout risk. Speak up in a team meeting — either we need a rotation, or everyone else needs to step up.
